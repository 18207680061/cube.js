...
mod tests {
    ...
    async fn test_metabase() -> Result<(), CubeError> {
        ...
        assert_eq!(
            ...
            | db        | NULL        | KibanaSampleDataEcommerce | customer_gender    | 12        | varchar(255) | NULL        | 65535         | 0              | 10             | 0        |         |            | 0             | 0                | NULL              | 0                | YES         | NULL          | NULL         | NULL        | NULL             | NO               | NO                 |\n\
            | db        | NULL        | KibanaSampleDataEcommerce | taxful_total_price | 12        | varchar(255) | NULL        | 65535         | 0              | 10             | 0        |         |            | 0             | 0                | NULL              | 0                | YES         | NULL          | NULL         | NULL        | NULL             | NO               | NO                 |\n\
